...
describe('Resting', function(){
  describe('rest function can be called with object as an argument', function() {
    it('And (re)assigns the health property of that object the value 10', function(){
    ...
    it('Returns that same object from the function', function(){
      const testCreature = {}
      const outPut = rest(testCreature)
      expect(outPut, 'creature not return from function').to.equal(testCreature)
    })

    it('Creates an alert popup with a message, If the health property of that object already has the value 10', function(){
...
describe('Picking up items', function(){
  describe('pickUpItem function can be called with a hero-like object as the first argument and a weapon-like object as the second argument', function() {
    it('Adds the weapon-like object as the last element of the inventory array of the hero-like object', function(){
      const testObject = {}
...
describe('Equip weapon', function(){
  describe('equipWeapon function can be called with a hero-like object as an argument', function(){
